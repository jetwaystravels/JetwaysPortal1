        ...
        public async Task<IActionResult> SearchResultFlight(SimpleAvailabilityRequestModel _GetfligthModel, string flightclass, string SameAirlineRT)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                if (responce.IsSuccessStatusCode)
                {
                    ...
                    //AirasiaTokan.token = results.data.token;
                    //AirasiaTokan.idleTimeoutInMinutes = results.data.idleTimeoutInMinutes;
                ...
                {
                    Filters.fareTypes = new[] { "R", "M", "MC", "SC" };
                    Filters.productClasses = new[] { "EC", "EP", "HF", "FS", "SM" };
                }
                ...
                if (flightclass != "B")
                {
                    ...
                    {
                        _getAvailabilityVer2Response = await objspicejetgetAvail_.GetTripAvailability(_GetfligthModel, _SpicejetlogonResponseobj, TotalCount, searchLog.Adults, searchLog.Children, searchLog.Infants, flightclass, SameAirlineRT, "spicejetonewaycorporate", SearchGuid);
                        int count1 = 0;
                ...
                {
                    _IndigoAvailabilityResponseobj = await objgetAvail_.GetCorporateTripAvailability(_GetfligthModel, _IndigologonResponseobj, TotalCount, searchLog.Adults, searchLog.Children, searchLog.Infants, flightclass,  "IndigoOneWay");
                    count2 = 0;
                ...
                if (_GetfligthModel.beginDate != null && _GetfligthModel.endDate != null)
                {
                    ...
                    _SimpleAvailabilityobjR.endDate = null; //"2023-12-20";//_GetfligthModel.endDate;
                    ...
                    if (flightclass != "B")
                    {
                        ...
                        if (responceR.IsSuccessStatusCode)
                        {
                            ...
                            //var oriDes = searchLog.DestCode + "|" + searchLog.OrgCode;
                            TempData["originR"] = _SimpleAvailabilityobjR.origin;
                            TempData["destinationR"] = _SimpleAvailabilityobjR.destination;
                            // data binding 
                            if (JsonObjR.data.results != null && ((JArray)JsonObjR.data.results).Count > 0)
                ...
                else
                {
                    ...
                    mongoAKashaToken.PassRequest = passobj;
                    ...
                    if (AirasiaTokan.token != "")
                    {
                        ...
                        mongoAirAsiaToken.PassRequest = passobj;
