function validateForm(){$("#multipleValuesForm").submit(function(){var i=document.getElementById("myInput").value,t,n,r,u,f,e,o,s,h;if(i=="")return n=document.getElementById("errororigin"),n.style.display="block",document.getElementById("myInput").focus(),!1;if(t=document.getElementById("myInput1").value,t=="")return n=document.getElementById("errordestinaton"),n.style.display="block",document.getElementById("myInput1").focus(),!1;if(i==t)return alert("Departure and Arrival Airport are same please change it.."),!1;if(r=document.getElementById("start-date").value,r=="")return u=document.getElementById("startDate"),u.style.display="block",document.getElementById("start-date").focus(),!1;if($("#round-tripid").is(":checked")&&(f=document.getElementById("end-date").value,f==""))return e=document.getElementById("endDate"),e.style.display="block",document.getElementById("end-date").focus(),!1;var c=parseInt(document.getElementById("field_adult").value),l=parseInt(document.getElementById("field_child").value),a=c+l;if(a>9)return alert("The combined total of adults and children must be 9 or less."),!1;o=document.getElementById("loader");o.style.display="block";$("body").css("overflow","hidden");s=document.getElementById("top-navbar-nav");s.style.display="none";h=document.querySelector(".navbar-brand");h.style.display="none"})}function checkOnlyThis(n){var t=document.getElementsByName("farecheck");t.forEach(t=>{t!==n&&(t.checked=!1)})}function toggleDropdownArrival(){var n=document.querySelector(".autoarrival input");n.focus();$(".chosen-drop").is(":visible")&&($(".autoarrival input").focus(),$(".chosen-drop").show())}function arrivalSelection(){var r;$(".autoarrival input").focus();var n=document.getElementById("arrivalItemId"),o=n.value,u=n.options[n.selectedIndex],t=u.text.split("-"),f=t[0].trim(),e=t[1].trim(),i=t[2].trim();document.getElementById("myInput1").value=f+"-"+e;document.getElementById("airportArval").innerHTML=i;r=document.getElementById("airportArval");r.innerHTML=i;r.title=i;$(".chosen-drop").hide();n.selectedIndex=-1}function filterCities(n){n.length<3||fetch(`/FlightSearchIndex/GetFilteredCities?query=${encodeURIComponent(n)}`).then(n=>n.json()).then(t=>{currentResults=t,updateDropdown(currentResults,n)})}function updateDropdown(n,t){const r=$("#arrivalItemId").next(".chosen-container").find(".chosen-drop").is(":visible"),u=document.getElementById(r?"arrivalItemId":"selectedItemId"),i=document.querySelector(r?".autoarrival input":".chosen-search input"),f=i.value;u.innerHTML=`<option value="" style="display: none;">Please select</option>
        ${n.map(n=>`<option value="${n.citycode}">${n.cityname} - ${n.citycode} - ${n.airportname}</option>`).join("")}`;$(u).trigger("chosen:updated");f===t&&(i.value=f);i.focus()}function toggleDropdown(){var n=document.querySelector(".chosen-search input");n.focus();$(".chosen-drop").is(":visible")&&($(".chosen-search input").focus(),$(".chosen-drop").show())}function handleSelection(){var r;$(".chosen-search input").focus();var n=document.getElementById("selectedItemId"),o=n.value,u=n.options[n.selectedIndex],t=u.text.split("-"),f=t[0].trim(),e=t[1].trim(),i=t[2].trim();document.getElementById("myInput").value=f+"-"+e;document.getElementById("airportName").innerHTML=i;r=document.getElementById("airportName");r.innerHTML=i;r.title=i;$(".chosen-drop").hide();n.selectedIndex=-1}localStorage.clear();$(document).ready(function(){$("#arrivalItemId").chosen();$("#arrivalItemId").trigger("chosen:open");$("#basic-addon1").on("click",function(n){n.stopPropagation();$("#arrivalItemId").trigger("chosen:open");$(".chosen-drop").show();$(".autoarrival input").attr("placeholder","To");$(".autoarrival").show();$(".autodropdown").hide();var t=document.querySelector(".autoarrival input");t.focus();t.hasAttribute("onkeyup")||t.setAttribute("onkeyup","filterCities(this.value)");t.addEventListener("paste",function(n){n.preventDefault()})});$(document.body).on("click",function(n){$(n.target).closest(".chosen-drop").length||$(n.target).is("#myInput1")||$(".chosen-drop").hide()})});document.addEventListener("DOMContentLoaded",function(){var u=document.getElementById("myInput1"),n,t,r;u.addEventListener("keydown",function(n){n.preventDefault()});u.addEventListener("paste",function(n){n.preventDefault()});n=document.getElementById("start-date");n.addEventListener("keydown",function(n){n.preventDefault()});n.addEventListener("paste",function(n){n.preventDefault()});t=document.getElementById("end-date");t.addEventListener("keydown",function(n){n.preventDefault()});t.addEventListener("paste",function(n){n.preventDefault()});$(".chosen-drop").css("display","none");var i="Chhatrapati Shivaji Maharaj International Airport";document.getElementById("myInput1").value="Mumbai-BOM";document.getElementById("airportArval").innerHTML=i;r=document.getElementById("airportArval");r.innerHTML=i;r.title=i});$(document).ready(function(){$("#selectedItemId").chosen();$(".chosen-drop").hide();$("#selectedItemId").trigger("chosen:open");$("#myInputbx").on("click",function(n){n.stopPropagation();$("#selectedItemId").trigger("chosen:open");$(".chosen-drop").show();$(".chosen-search input").attr("placeholder"," From");$(".autoarrival").hide();$(".autodropdown").show();var t=document.querySelector(".chosen-search input");t.focus();t.hasAttribute("onkeyup")||t.setAttribute("onkeyup","filterCities(this.value)");t.addEventListener("paste",function(n){n.preventDefault()})});$(document.body).on("click",function(n){$(n.target).closest(".chosen-drop").length||$(n.target).is("#myInput")||$(".chosen-drop").hide()})});let currentResults=[];$(document).ready(function(){const n=document.getElementById("myInput");n.addEventListener("input",function(){const t=n.value})});document.addEventListener("DOMContentLoaded",function(){var t,i;$(".chosen-drop").css("display","none");var n="Indira Gandhi International Airport";document.getElementById("myInput").value="New Delhi-DEL";document.getElementById("airportName").innerHTML=n;t=document.getElementById("airportName");t.innerHTML=n;t.title=n;i=document.getElementById("myInput");i.addEventListener("keydown",function(n){n.preventDefault()});i.addEventListener("paste",function(n){n.preventDefault()})});$(document).ready(function(){$(".rplc-btn").on("click",function(n){var r=$("#myInput").val(),u=$("#myInput1").val(),t,i;return $("#myInput").val(u),$("#myInput1").val(r),t=$("#airportName").text(),i=$("#airportArval").text(),$("#airportName").text(i).attr("title",i),$("#airportArval").text(t).attr("title",t),r==u||t==i?(alert("Departure and Arrival Airport are the same. Please change it."),n.preventDefault(),!1):void 0});$('.S-option input[type="radio"]').on("change",function(){$('.S-option input[type="radio"]').not(this).prop("checked",!1)});$("#end-date").prop("disabled",!0);$("#bgEnddate").css("background-color","#e9ecef");$(".endselect").on("click",function(){$("#round-tripid").prop("checked",!0);let n=new Date;n.setDate(n.getDate()+2);let i=n.toISOString().split("T")[0];$("#end-date").val(i);let t=new Date;t.setDate(t.getDate()+1);let r=t.toISOString().split("T")[0];$("#start-date").val(r);$("#bgEnddate").css("background-color","#fff");$(".hasDatepicker").css("background-color","#fff");$("#end-date").css("visibility","visible");$(".hasDatepicker").prop("disabled",!1);$(".rounddateinput").css("display","none")});$('input[type="radio"]').on("change",function(){var n,s,t,h;if($("#round-tripid").is(":checked")){$("#end-date").prop("disabled",!1);$("#bgEnddate").css("background-color","#fff");$("#end-date").css("visibility","visible");n=new Date;n.setDate(n.getDate()+2);var i=n.getDate(),r=n.getMonth()+1,e=n.getFullYear();i>new Date(e,r,0).getDate()&&(i=new Date(e,r,0).getDate());s=e+"-"+(r<10?"0"+r:r)+"-"+(i<10?"0"+i:i);t=new Date;t.setDate(t.getDate()+1);var u=t.getDate(),f=t.getMonth()+1,o=t.getFullYear();u>new Date(o,f,0).getDate()&&(u=new Date(o,f,0).getDate());h=o+"-"+(f<10?"0"+f:f)+"-"+(u<10?"0"+u:u);$("#end-date").val(s);$("#start-date").val(h);const c=document.querySelector(".rounddateinput");c.style.display="none"}else if($("#multi-cityid").is(":checked")){$("#end-date").prop("disabled",!1);$("#bgEnddate").css("background-color","#fff");$("#end-date").css("visibility","visible");n=new Date;n.setDate(n.getDate()+2);var i=n.getDate(),r=n.getMonth()+1,e=n.getFullYear();i>new Date(e,r,0).getDate()&&(i=new Date(e,r,0).getDate());s=e+"-"+(r<10?"0"+r:r)+"-"+(i<10?"0"+i:i);t=new Date;t.setDate(t.getDate()+1);var u=t.getDate(),f=t.getMonth()+1,o=t.getFullYear();u>new Date(o,f,0).getDate()&&(u=new Date(o,f,0).getDate());h=o+"-"+(f<10?"0"+f:f)+"-"+(u<10?"0"+u:u);$("#end-date").val(s);$("#start-date").val(h);const c=document.querySelector(".rounddateinput");c.style.display="none"}else{$("#end-date").prop("disabled",!0);$("#bgEnddate").css("background-color","#e9ecef");$("#end-date").css("visibility","hidden");const n=document.querySelector(".rounddateinput");n.style.display="block"}});$(function(){var n=new Date,r=String(n.getDate()).padStart(2,"0"),t=String(n.getMonth()+1).padStart(2,"0"),i=n.getFullYear(),f=new Date(i,t,0).getDate(),u=i+"-"+t+"-"+r;$("#start-date").val(u)});$(function(){$("#start-date").datepicker({dateFormat:"yy-mm-dd",numberOfMonths:2,maxDate:"+12m",minDate:"0",onSelect:function(){var n=$(this).datepicker("getDate");$("#end-date").datepicker("option","minDate",n)}});$("#end-date").datepicker({dateFormat:"yy-mm-dd",numberOfMonths:2,maxDate:"+12m",minDate:"0",onSelect:function(){var n=$(this).datepicker("getDate");$("#start-date").datepicker("option","maxDate",n)}})});var r=6,u=9,n=parseInt(localStorage.getItem("adultcount"))||1,i=0,t=0;$("#count_adult").text(n);$("#field_adult").val(n);$(".increment").on("click",function(){n<u&&(n++,$("#count_adult").text(n),$("#field_adult").val(n),localStorage.setItem("adultcount",n))});$(".decrement").on("click",function(){n>1&&(n--,$("#count_adult").text(n),$("#field_adult").val(n),localStorage.setItem("adultcount",n),t>n&&(t=n,$("#count_infant").text(t),$("#field_infant").val(t)))});$(".increment1").on("click",function(){i<r&&(i++,$("#count_child").text(i),$("#field_child").val(i))});$(".decrement1").on("click",function(){i>0&&(i--,$("#count_child").text(i),$("#field_child").val(i))});$(".increment2").on("click",function(){if(t<r){var n=parseInt(localStorage.getItem("adultcount"))||1;if(t>=n)return alert("Number of infants cannot be more than adults"),!1;t++;$("#count_infant").text(t);$("#field_infant").val(t)}});$(".decrement2").on("click",function(){t>0&&(t--,$("#count_infant").text(t),$("#field_infant").val(t))})});
/*!
